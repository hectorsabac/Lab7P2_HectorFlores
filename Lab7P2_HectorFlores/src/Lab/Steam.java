...
public class Steam {
    ...
    */
    ...
    public void addPlayer(String user, String password, String nombre, long nacimiento, String Imagen, String TipodeUsuario)throws IOException{
        //Posiciona el puntero al final del archivo
        players.seek(players.length());
        
        //Extrae el coddigo de cliente y escribe el siguiente codigo en el archivo
        int code = getCode(1);
        
        //Escribe el codigo del cliente
        players.writeInt(code);
        //Escribe el username del cliente
        players.writeUTF(user);
        //Escribe la password del cleinte
        players.writeUTF(password);
        //Escribe el nombre del cliente
        players.writeUTF(nombre);
        //Escribe la fecha de nacimiento del cliente
        players.writeLong(nacimiento);
        //Escribe el default downloads del cliente en 0
        players.writeInt(0);
        //Escribe el nombre de la imagen
        players.writeUTF(Imagen);
        //Escribe el tipo de usuario
        players.writeUTF(TipodeUsuario);
    }
